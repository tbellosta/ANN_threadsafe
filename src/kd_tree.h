...
public:
	...
	virtual void ann_search(ANNdist, int &, ANNpoint &, double &, ANNpointArray &, ANNmin_k *, int &) = 0;		// tree search
...
public:
	...
	virtual void ann_search(ANNdist, int &, ANNpoint &, double &, ANNpointArray &, ANNmin_k *, int &);			// standard search
