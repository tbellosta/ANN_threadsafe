...
void ANNkd_split::ann_search(ANNdist box_dist, int &ANNkdDim, ANNpoint &ANNkdQ, double &ANNkdMaxErr, ANNpointArray &ANNkdPts, ANNmin_k *ANNkdPointMK, int &ANNptsVisited)
{
	...
	if (cut_diff < 0) {					// left of cutting plane
		child[ANN_LO]->ann_search(box_dist, ANNkdDim, ANNkdQ, ANNkdMaxErr, ANNkdPts, ANNkdPointMK, ANNptsVisited);// visit closer child first
		...
		if (box_dist * ANNkdMaxErr < ANNkdPointMK->max_key())
			child[ANN_HI]->ann_search(box_dist, ANNkdDim, ANNkdQ, ANNkdMaxErr, ANNkdPts, ANNkdPointMK, ANNptsVisited);

	}
	else {								// right of cutting plane
		child[ANN_HI]->ann_search(box_dist, ANNkdDim, ANNkdQ, ANNkdMaxErr, ANNkdPts, ANNkdPointMK, ANNptsVisited);// visit closer child first
		...
		box_dist = (ANNdist) ANN_SUM(box_dist,
				ANN_DIFF(ANN_POW(box_diff), ANN_POW(cut_diff)));
										...
										// visit further child if close enough
		if (box_dist * ANNkdMaxErr < ANNkdPointMK->max_key())
			child[ANN_LO]->ann_search(box_dist, ANNkdDim, ANNkdQ, ANNkdMaxErr, ANNkdPts, ANNkdPointMK, ANNptsVisited);
...
void ANNkd_leaf::ann_search(ANNdist box_dist, int &ANNkdDim, ANNpoint &ANNkdQ, double &ANNkdMaxErr, ANNpointArray &ANNkdPts, ANNmin_k *ANNkdPointMK, int &ANNptsVisited)
{
